          ...
          <View style={{ alignItems: "center" }}>
            ...
            <View style={{ flexDirection: "row", marginTop: "5%" }}>
              <View style={{ alignItems: "center", marginHorizontal: "3%" }}>
                <TouchableOpacity>
                  <Image
                    source={require("../assets/domino.png")}
                    style={styles.foodIcon}
                  ></Image>
                </TouchableOpacity>
                <Text style={styles.foodIconText}>Domino's</Text>
              </View>
              <View style={{ alignItems: "center", marginHorizontal: "3%" }}>
                <TouchableOpacity>
                  <Image
                ...
                <Text style={styles.foodIconText}>Subway</Text>
              </View>
              <View style={{ alignItems: "center", marginHorizontal: "3%" }}>
                <TouchableOpacity>
                  <Image
                ...
                <Text style={styles.foodIconText}>KFC</Text>
              </View>
            </View>
            <View
              style={{
            ...
            <View style={{ flexDirection: "row", marginTop: "5%", }}>
              <View style={{ marginHorizontal: "2%", flexShrink:1}}>
                <TouchableOpacity>
                  <Image
                ...
                <Text style={[styles.foodDetails, { fontWeight: "bold" }]}>
                  Brew Bliss Café
                </Text>
                <Text
                  style={{
                ...
                >
                  Est esse nisi proident.
                </Text>
              </View>
              <View style={{ marginHorizontal: "2%", flexShrink:2 }}>
                <TouchableOpacity>
                  <Image
                ...
                >
                  Consectetur incididunt consequat in.
                </Text>
              </View>
            </View>
          </View>
